...
urlpatterns = [
    ...
    path('delete-order/<int:pk>/', deleteCheckedoutOrder, name='delete-checkout'),
    ...
    path('delete-personal-account/<int:pk>', deletePersonalAccount, name='delete-personal-account'),
    path('search/', searchProducts, name='search'),
    path('sort-product/<str:choice>/', sortProducts, name='sort-product'),
